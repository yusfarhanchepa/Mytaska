            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" name="form" action="../../model/p_apply_cuti.php" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="sebab_cuti" class="form-control" placeholder="Reason for Applying (Sick, etc.)">
                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Type of Holiday </label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-line">
                                            <div class="demo-radio-button">
                                                <input name="jenis_cuti"  value="Cuti Tahunan" type="radio" id="radio_7" class="radio-col-red"  />
                                                <label for="radio_7">Cuti Tahunan</label>
                                                <input name="jenis_cuti" value="Cuti Sakit" type="radio" id="radio_8" class="radio-col-red" />
                                                <label for="radio_8">Cuti Sakit</label>
                                                <input name="jenis_cuti" value="Cuti Bersalin" type="radio" id="radio_9" class="radio-col-red" />
                                                <label for="radio_9">Cuti Bersalin</label>
                                             </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Upload MC Picture (if "Cuti Sakit")</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        
                                            <div class="form-line">
                                            <input type="file" name="mc_picture" required>
                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">How Many Days? </label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        
                                            
                                            <div class="form-line">
                                                <input type="text" name="no_of_days" class="form-control" placeholder="Berapa Hari?">
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-line">
                                    <input name="start_date" type="date" id="email_address_2" class="form-control" placeholder="Start Date">
                                    </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            ...
                                            <div class="form-line">
                                                <input name="end_date" type="date" id="email_address_2" class="form-control" placeholder="Start Date">
                                            </div>
