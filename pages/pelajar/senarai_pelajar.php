 ...
 $query ="SELECT * FROM pelajar join bapa on pelajar.id_bapa=bapa.id_bapa  where pelajar.id_taska=$id_taska ";  
                        ...
                        {  
                             ...
                             <tr>  
                                 <td>'.$count.'</td> 
                                  ...
                                  <td>'.$row["umur"].'</td>  
                                  <td>'.$row["nama_bapa"].'</td>  
                                  <td>'.$row["phone_bapa"].'</td>  
                                  <td>'.$row["nama_ibu"].'</td>  
                                  <td>'.$row["phone_ibu"].'</td> 
                                  <td>
                                  <a href="detail_pelajar.php?id_pelajar=' .$row["id_pelajar"].'" class="btn btn-info" role="button">Details</a>
                                   
                                  <a href="#"  onclick="hapus_pelajar('.$row["id_pelajar"].')" class="btn btn-danger" role="button">Delete</a>
                                  </td> 
...
<script>
      ...
      function hapus_pelajar(id_pelajar) {
        ...
        swal({
                    ...
                    window.location = "../../model/p_hapus_pelajar.php?id_pelajar=" +id_pelajar;
