               ...
               <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <h3 align="center">List of Money Out</h3>  
...
$count=1;
$query="Select *  from kewangan  where id_taska=$id_taska order by id_kewangan desc ;";
...
if($hitung){
  ...
  while ($cetak=$hasil->fetch_assoc()) { 
    ...
    Print "<tr>";
    Print '<td>' .$count . "</td>";
    Print '<td>'. $cetak['tarikh'] . "</td>";
    Print '<td>'. $cetak['nama'] . "</td>";
    Print '<td>'. $cetak['reference'] . "</td>";
    Print '<td> <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
    <a class="btn btn-primary " href="../../model/upload/'. $cetak['image'] .'" data-sub-html="Demo Description">Click Here</a>
    </div></td>';
    Print '<td>
    <a href="#"  onclick="hapus_kewangan('.$cetak['id_kewangan'].')" class="btn btn-danger" role="button">delete</a>
    </td>';
    Print '<td>'. $cetak['duit_keluar'] . "</td>";
    Print "</tr>";
...
$query1="Select sum(duit_keluar) as total  from kewangan  where id_taska=$id_taska; ;";
...
<script>
      ...
      function hapus_kewangan(id_kewangan) {
        ...
        swal({
                    ...
                    window.location = "../../model/p_hapus_kewangan.php?id_kewangan=" +id_kewangan;
