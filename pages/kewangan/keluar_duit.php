            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="header bg-orange align-center">
                        ...
                        <div class="body">
                        <form class="form-horizontal"  name="form" action="../../model/p_duit_keluar.php" method="post" enctype='multipart/form-data'>
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                        ...
                                        <input type="text" name="tarikh"  class="datepicker form-control" readonly placeholder="Select Date" required>   
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                <label for="email_address_2">No. Reference</label>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                        ...
                                        <input type="number" name="duit_keluar" class="form-control"   required>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                <label for="email_address_2">Picture(Proof) </label>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
