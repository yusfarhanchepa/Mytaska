        ...
        <div class="container-fluid">
            ...
            <!-- Body Copy -->
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form class="form-horizontal" name="form" action="../model/p_tambah_activity.php" method="post" enctype="multipart/form-data">
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                            <label for="email_address_2">Activity </label>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                            <input  name="id_taska" value="<?php echo $id_taska  ?>" class="form-control"  type="hidden" required >
                                                <input type="text" name="name_activity" class="form-control" placeholder="name activity" required>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="date_activity" placeholder="date"  required>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="card">
                                <div class="header  bg-blue align-center">
                                    <h3 align="center">List of Activity</h3>
