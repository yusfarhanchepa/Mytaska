        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <h3 align="center">List of children</h3>  
                        ...
                        <div class="body table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                $id=$_SESSION['id'];
                                        ...
                                        $count=1;
                                        $query="Select * from pelajar where id_bapa=$id AND id_taska=$id_taska;";
                                        ...
                                        while ($cetak=$hasil->fetch_assoc()) { 
                                            ...
                                            Print '<td>'. $cetak['umur'] . "</td>";
                                            Print '<td>'. $cetak['jantina'] . "</td>";
                                            Print '<td>'. $cetak['penyakit_lain'] . "</td>";
                                            Print '<td>'. $cetak['alahan'] . "</td>";
                                            Print '<td><a href="progress_anak.php?id_pelajar='. $cetak['id_pelajar'] .'" class="btn btn-info" role="button">Performance</a></td>';
                                            Print '<td> <a href="edit_anak.php?id_pelajar='. $cetak['id_pelajar'] .'" class="btn btn-warning" role="button">Edit</a>
                                            <a href="#"  onclick="hapus_anak('.$cetak['id_pelajar'].')" class="btn btn-danger" role="button">delete</a>
                                            </td>';
