...
<aside id="leftsidebar" class="sidebar">
 ...
 <!-- #User Info -->
            ...
            <ul class="list">
                ...
                <li>
                    <a href="../../pages/progress/addProgress.php" class="menu-toggle">
                        <i class="material-icons">widgets</i>
            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" name="form" action="../../model/p_tambah_news2.php" enctype="multipart/form-data" method="post">
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-line">
                                        <input name="dates" type="date" id="email_address_2" class="form-control" placeholder="Date">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <input type="text" name="link" class="form-control" placeholder="News Link" required>
