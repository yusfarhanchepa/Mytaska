...
if(isset($_GET['id_news'])){
        ...
        echo '<script>window.location=("edit_news.php"); </script>';
    }
            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" name="form" action="../../model/p_edit_news.php?id_news=<?php echo $id_news; ?>" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <input type="text" name="title" value="<?php echo $title;  ?>" class="form-control" placeholder="News Title" required>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Details</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-line">
                                            
                                        <textarea class="form-control" name="details" <?php echo $details;  ?> rows="3"><?php echo $details;  ?></textarea>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-line">
                                        <input name="dates" value="<?php echo $dates;  ?>"type="date" id="email_address_2" class="form-control" placeholder="Date">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
