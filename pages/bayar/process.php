...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$_SESSION['id_bapa']  = $_POST['id_bapa']; 
	$_SESSION['id_taska']  = $_POST['id_taska']; 
	$_SESSION['nama_bapa']  = $_POST['nama_bapa']; 
	...
	if(_GET('paypal')=='checkout'){
		...
		$id_taska = _POST('id_taska'); // Item Quantity
		...
		*/		
		...
		$paypal->SetExpressCheckOut($products, $charges,$id_taska);		
