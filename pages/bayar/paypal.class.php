...
$id_bapa=$_SESSION['id_bapa'] ;
$id_taska=$_SESSION['id_taska'] ;
$nama_bapa=$_SESSION['nama_bapa'] ;
...
////////////////////////////////
		...
		function GetTransactionDetails(){
			...
			if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])){
				...
				$ProductsTotalAmount = urldecode($httpParsedResponseAr["AMT"]);
				$tarikh = urldecode($httpParsedResponseAr["TIMESTAMP"]);
				$id_bapa=$_SESSION['id_bapa'] ;
				$id_taska=$_SESSION['id_taska'] ;
				$nama_bapa=$_SESSION['nama_bapa'] ;
				...
				$insert_row = $mysqli->query("INSERT INTO bayaran 
				(id_bapa,id_taska,status,nama_bapa,email_bapa,no_rujukan,phone_bapa, jumlah_bayaran,t_bayaran)
				VALUES ('$id_bapa','$id_taska','Verified','$nama_bapa','$buyerEmail','$TransactionID','$ItemName', '$ProductsTotalAmount', '$tarikh')");
