            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" name="form"  action="../../model/p_edit_bapa.php?id_bapa=<?php echo $id_bapa; ?>" method="POST">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-3 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="ic_bapa" class="form-control" value="<?php echo $ic_bapa; ?>" placeholder="Nama Kelas">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="nama_bapa" class="form-control" value="<?php echo $nama_bapa; ?>"  placeholder="Nama Guru">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="umur_bapa" class="form-control" value="<?php echo $umur_bapa; ?>"  placeholder="Nama Guru">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="number" name="phone_bapa" class="form-control" value="<?php echo $phone_bapa; ?>"  placeholder="1-20">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="alamat_bapa" class="form-control" value="<?php echo $alamat_bapa; ?>" placeholder="---------">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="email_bapa" class="form-control" value="<?php echo $email_bapa; ?>"  placeholder="">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="pekerjaan_bapa" class="form-control" value="<?php echo $pekerjaan_bapa; ?>" placeholder="---------">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="alamat_p_bapa" class="form-control" value="<?php echo $alamat_p_bapa; ?>" placeholder="---------">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="gaji_ibu" class="form-control" value="<?php echo $gaji_bapa; ?>" placeholder="---------">
