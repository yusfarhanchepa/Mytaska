            ...
            <!-- Body Copy -->
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <form class="form-horizontal" name="form" action="../model/p_tambah_news.php" method="post" enctype="multipart/form-data">
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="details" placeholder="details" rows="3"></textarea>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Dates </label>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="header  bg-cyan align-center">
                                    <h3 align="center">List of News</h3>
                                    <ul class="header-dropdown m-r--5">
                                        <li class="dropdown">
                                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                <i class="material-icons">more_vert</i>
...
$count=1;
$query="Select * from news where id_taska=$id_taska;";
                ...
                Print     '<ul class="header-dropdown m-r--5">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <p></p>
                                <div class="col-md-6">';
                     Print   '<img src="../model/'. $cetak['pictures'] .'" width="400" height="250">';
                     Print    '</div>';

                     Print          '<div class="col-md-6">
                                <p class="font-bold col-cyan">Detail</p>';
                     Print     '<p>'. $cetak['details'] .'</p>';
                     Print     '<p class="font-bold col-cyan">Advantage</p>';
                     Print     '<p>'. $cetak['dates'] .'</p>';
