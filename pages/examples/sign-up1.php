    ...
    <div class="signup-box">
        ...
        <div class="card">
            <div class="body">             
             ...
             <li role="presentation" class="active"><a href="#profile_animation_1" data-toggle="tab">Register Admin</a></li>
            
             </ul>

                                    <!-- Tab panes -->
           <div class="tab-content">
           <div role="tabpanel" class="tab-pane animated flipInX active" id="profile_animation_1">
           <div class="msg">
