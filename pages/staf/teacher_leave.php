        ...
        <div class="container-fluid">
               ...
               <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <h3 align="center">Request Leave</h3>  
                        ...
                        $query ="SELECT * FROM cuti join staf on cuti.id_staf=staf.id_staf  where staf.id_taska=$id_taska and status='Pending'";  
                        ...
                        {  
                             ...
                             <tr>  
                                  ...
                                  <td>'.$row["sebab_cuti"].'</td>  
                                  <td>'.$row["no_of_days"].'</td>  
                                  <td>'.$row["start_date"].'</td>  
                                  <td>'.$row["end_date"].'</td>  
                                  <td>'.$row["cuti"].'</td> 
                                  <td>
                                  <a href="#"  onclick="reject('.$row["id_staf"].','.$row["cuti"].','.$row["no_of_days"].')" class="btn btn-danger" role="button">Reject</a>
                                  <a href="#"  onclick="approve('.$row["id_staf"].','.$row["cuti"].','.$row["no_of_days"].')" class="btn btn-warning" role="button">Approve</a>
                                  </td> 
                        ...
                        ?> 
                            ...
                            <script>
                                ...
                                function reject(id_staf,cuti,no_of_days) {
                                    ...
                                    swal({
                                                ...
                                                window.location = "../../model/p_reject.php?id_staf=" +id_staf+"&cuti="+cuti+"&no_of_days="+no_of_days;

                                            })

                                }

                                function approve(id_staf,cuti,no_of_days) {
                                    ...
                                    swal({
                                                ...
                                                window.location = "../../model/p_approve.php?id_staf=" +id_staf+"&cuti="+cuti+"&no_of_days="+no_of_days;
            ...
            <!-- #END# Striped Rows -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header  bg-cyan align-center">
                        <h3 align="center">Approved Leave</h3>  
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="material-icons">more_vert</i>
                        ...
                        $query ="SELECT * FROM cuti join staf on cuti.id_staf=staf.id_staf  where staf.id_taska=$id_taska and status='Approved'";  
                        $result = mysqli_query($conn, $query); 
            ...
            <!-- #END# Striped Rows -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header  bg-cyan align-center">
                        <h3 align="center">Reject Leave</h3>  
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="material-icons">more_vert</i>
                        ...
                        $query ="SELECT * FROM cuti join staf on cuti.id_staf=staf.id_staf  where staf.id_taska=$id_taska and status='Reject'";  
                        $result = mysqli_query($conn, $query); 
