 ...
 $query ="SELECT * FROM staf  where id_taska=$id_taska";  
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        {  
                             ...
                             <tr>  
                                  <td>'.$row["nama_staf"].'</td>  
                                  <td>'.$row["no_ic_staf"].'</td>  
                                  <td>'.$row["no_telefon"].'</td>  
                                  <td>'.$row["kategori_staf"].'</td>  
                                  <td>'.$row["tarikh_mula_berkhidmat"].'</td>  
                                  <td>'.$row["pencapaian_akademik_tertinggi"].'</td>  
                                  <td>'.$row["gaji"].'</td> 
                                  <td>
                                  <a href="edit_staf.php?id_staf=' .$row["id_staf"].'" class="btn btn-warning" role="button">Edit</a>
                                  <a href="#"  onclick="hapus_staf('.$row["id_staf"].')" class="btn btn-danger" role="button">Delete</a>
                                  </td> 
                            ...
                            <script>
                                ...
                                function hapus_staf(id_staf) {
                                    ...
                                    swal({
                                                ...
                                                window.location = "../../model/p_hapus_staf.php?id_staf=" +id_staf;
