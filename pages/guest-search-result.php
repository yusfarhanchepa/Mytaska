...
if(isset($_GET['search-address'])){
    
        $alamat = $_GET['search-address'];

		$query="SELECT * FROM taskauser WHERE nama_taska LIKE '%$alamat%' OR alamat_organisasi LIKE '%$alamat%';";
...
<html>
    <head>
        ...
        <title>Search Result - MyTaska Guest</title>
	    	...
	    	<section class="tl-inner-banner">
	    		<div class="container">
	    			...
	    			<ul class="tl-breadcrumb-listed">
	    				...
	    				<li class="active">Hasil Carian</li>
	    			</ul>
	    		</div>
									...
									<div class="tl-filterlist">
										...
										<div class="tl-right-listed">
											<ul class="nav nav-tabs">
											  ...
											  <span class="found-pages"><?php echo $hitung; ?> tadika telah dijumpai</span>
