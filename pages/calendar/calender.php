...
try
{
	$bdd = new PDO('mysql:host=localhost;dbname=mytaska;charset=utf8', 'root', '');
}
catch(Exception $e)
{
...
$sql = "SELECT id, title, start, end, color FROM calenderevents ";
 ...
 <!-- #User Info -->
    ...
    <section class="content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header" style="border-bottom:0px solid;">
                    <h3 align="center"></h3>
