...
<aside id="leftsidebar" class="sidebar">
 ...
 <!-- #User Info -->
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="javascript:void(0);">Mytaska</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" name="form" action="../../model/p_tambah_kelas.php" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <input  name="id_taska" value="<?php echo $id_taska  ?>" class="form-control"  type="hidden" required >
                                                <input type="text" name="nama_kelas" class="form-control" placeholder="Class Name" required>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="nama_guru" class="form-control" placeholder="Teacher Name" required>
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                         ...
                                         <div class="demo-radio-button">
                                            <input name="sesi"  value="Pagi" type="radio" id="radio_7" class="radio-col-red"  />
                                            <label for="radio_7">Morning</label>
                                            <input name="sesi" value="Petang" type="radio" id="radio_8" class="radio-col-red" />
                                ...
                                <div class="row clearfix">
                                 ...
                                 <div class="demo-radio-button">
                                    <input name="integrasi"  value="Ya" type="radio" id="radio_13" class="radio-col-red"  >
                                    <label for="radio_13">Yes</label>
                                    <input name="integrasi" value="Tidak" type="radio" id="radio_14" class="radio-col-red" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                                ...
                                                <input  type="number" name="kapasiti" class="form-control" placeholder="1-20" required>
