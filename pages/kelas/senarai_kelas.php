...
$count=1;
$query="Select * from kelas  where id_taska=$id_taska;";
...
if($hitung){
  ...
  while ($cetak=$hasil->fetch_assoc()) { 
    ...
    Print "<tr>";
    Print '<td>' .$count . "</td>";
    Print '<td>'. $cetak['nama_kelas'] . "</td>";
    Print '<td>'. $cetak['nama_guru'] . "</td>";
    Print '<td>'. $cetak['sesi'] . "</td>";
    Print '<td>'. $cetak['integrasi'] . "</td>";
    Print '<td>'. $cetak['kapasiti'] . "</td>";
    Print '<td>'. $cetak['catatan'] . "</td>";
    Print '<td> <a href="edit_kelas.php?id_kelas='. $cetak['id_kelas'] .'" class="btn btn-warning" role="button">Edit</a>
    <a href="#"  onclick="hapus_kelas('.$cetak['id_kelas'].')" class="btn btn-danger" role="button">delete</a>
    </td>';
...
<script>
      ...
      function hapus_kelas(id_kelas) {
        ...
        swal({
                    ...
                    window.location = "../../model/p_hapus_kelas.php?id_kelas=" +id_kelas;
