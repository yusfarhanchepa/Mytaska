 ...
 <!-- #User Info -->
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink  hover-expand-effect  hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            $result = $conn->query("SELECT COUNT(*) AS taskCount FROM tasks where id_taska=$id_taska ;");
                    ...
                    <div class="info-box bg-light-blue hover-expand-effect   hover-zoom-effect">
                        ...
                        <div class="content">
                           ...
                           <?php
                            ...
                            $result = $conn->query("SELECT COUNT(*) AS bayaranCount FROM activity  where id_taska=$id_taska  ;");
                            $row = $result->fetch_assoc();
            ...
            $query2="Select * from announcement  where id_taska=$id_taska;";
