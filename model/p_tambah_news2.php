...
if($statement = $conn ->prepare($query)){
    ...
    if($statement -> execute()){
        ...
        echo '<script>window.alert( "Successful added!");window.location=("../pages/news/tambah_news.php"); </script>';
        ...
        echo '<script>window.alert( "Failed to Saved!"); window.location("../pages/news/tambah_news.php"); </script>';
    }
