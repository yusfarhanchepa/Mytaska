            ...
            <div class="block-header">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                               <div class="card">
                                   ...
                                   <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <h3><a class="btn btn-info pull-right" href="../../pages/attendance/studentAttendance.php"> Back </a><h3>
                                        </div>
                                   </div>
                                   ...
                                   <form class="form-horizontal" name="form" action="../../pages/attendance/studentAttendance.php" method="post">
                                    ...
                                    $query="Select distinct dates from attendance_records;";
                                    ...
                                    while ($cetak=$hasil->fetch_assoc()) { 
                                        ...
                                        Print '<td> <a href="../../pages/attendance/showAttendance.php?dates='. $cetak['dates'] .'" class="btn btn-warning" role="button">Show</a>
                                        <input type="hidden" value="'.$cetak['dates'].'" name="dates[]">
                                        </td>';
